...
public class TestLocallyTypeErasedPrograms {
	...
	/**
	 * Take all .javali files in the "local" subfolder where local type
	 * information _may_ be missing
	 */
	...
	/**
	 * For now, simply run the compiler on the tests with missing local types
	 * (all valid programs).
	 * 
	 * @throws Throwable
	 */
