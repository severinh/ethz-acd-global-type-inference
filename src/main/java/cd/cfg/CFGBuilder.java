...
public class CFGBuilder {
	...
	public void build(MethodDecl mdecl) {
		...
		cfg.start = cfg.newBlock(); // Note: Use newBlock() to create new basic
									// blocks
		cfg.end = cfg.newBlock(); // unique exit block to which all blocks that
									// end with a return stmt. lead
