...
public class Config {
	...
	public static enum SystemKind { LINUX, WINDOWS, MACOSX };
    ...
    /** 
     * The assembler directive used to start the section for string data
     * (if different from {@link #DATA_INT_SECTION} */
    ...
    /** 
     * Defines the assembler command to use.  Should be a string array
     * where each entry is one argument.  Use the special string
     * "$0" to refer to the output file, and $1 to refer to the
     * ".s" file. */
    public static final String[] ASM; 
    
    /**
     * The directory from which to run the assembler.  In a CYGWIN
     * installation, this can make a big difference!
     */
