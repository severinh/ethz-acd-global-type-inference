...
public abstract class Ast {
	...
	public static abstract class Expr extends Ast {
		...
		/**
		 * Type that this expression will evaluate to (computed in semantic
		 * phase).
		 */
	...
	public static class Var extends LeafExpr {
		...
		/**
		 * Use this static function to build an instance after the semantic
		 * phase; it fills in the {@link #type} and {@link #sym} fields.
		 */
	...
	public static class Assign extends Stmt {
		...
		@Override
		public Ast deepCopy() {
			return new Assign((Expr) left().deepCopy(), (Expr) right()
					.deepCopy());
		}
	...
	public static class ReturnStmt extends Stmt {
		...
		@Override
		public Ast deepCopy() {
			return new ReturnStmt(arg() != null ? (Expr) arg().deepCopy()
					: null);
		}
	...
	public static class WhileLoop extends Stmt {
		...
		@Override
		public Ast deepCopy() {
			return new WhileLoop((Expr) condition().deepCopy(), body()
					.deepCopy());
		}
	}
	...
	public static class MethodDecl extends Decl {
		...
		public MethodDecl(String returnType, String name,
				List<String> argumentTypes, List<String> argumentNames,
				Seq decls, Seq body) {
			super(2);
